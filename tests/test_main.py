...
@pytest.mark.parametrize("args, expected_output", [
    (["script_name.py"], "Error: Debes incluir un argumento válido: [INFO | INFOP | DIA [YYMMDD] ]"),
    (["script_name.py", "INVALID_ARGUMENT"], "Error: Debes incluir un argumento válido: [INFO | INFOP | DIA [YYMMDD] ]"),
